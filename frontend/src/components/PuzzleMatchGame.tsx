...
export default function PuzzleMatchGame({ onBack, onGameComplete }: PuzzleMatchGameProps) {
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6">
        <AnimatePresence mode="wait">
          {gameState === 'menu' && (
            <GameMenu
              title="Puzzle Match"
              description="Match logical pairs together. Find the relationship between the cards."
              icon={<Puzzle className="w-14 h-14 text-emerald-400" />}
