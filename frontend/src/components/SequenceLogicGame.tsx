...
export default function SequenceLogicGame({ onBack, onGameComplete }: SequenceLogicGameProps) {
        ...
        <AnimatePresence mode="wait">
          {gameState === 'menu' && (
            <GameMenu
              ...
              description="Find the logical pattern in the numbers and select the next one."
