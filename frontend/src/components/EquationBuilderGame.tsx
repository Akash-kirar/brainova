...
export default function EquationBuilderGame({ onBack, onGameComplete }: EquationBuilderGameProps) {
        ...
        <AnimatePresence mode="wait">
          {gameState === 'menu' && (
            <GameMenu
              ...
              description="Select numbers that add up exactly to the target number."
              icon={<Calculator className="w-14 h-14 text-emerald-400" />}
