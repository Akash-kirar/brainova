...
export default function PatternRecallGame({ onBack, onGameComplete, difficulty = 'easy' }: PatternRecallGameProps) {
        ...
        <AnimatePresence mode="wait">
          {gameState === 'menu' && (
            <motion.div key="menu" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="text-center max-w-sm w-full">
              ...
              <h2 className="text-3xl font-bold mb-4">Pattern Recall</h2>
              <p className="text-white/60 mb-12">Remember the path and recreate it.</p>
