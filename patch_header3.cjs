...
const targetStr = `                  <div className="absolute top-0 left-0 right-0 z-10 flex items-center justify-end px-4 pt-4 pb-2 pointer-events-none">
