...
export default function SmartGridPuzzleGame({ onBack, onGameComplete }: SmartGridPuzzleGameProps) {
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6">
        <AnimatePresence mode="wait">
          {gameState === 'menu' && (
            <GameMenu
              title="Smart Grid"
              description="Turn off all the lights. Clicking a cell toggles it and its adjacent neighbors."
              icon={<Grid className="w-14 h-14 text-cyan-400" />}
