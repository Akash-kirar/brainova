...
export default function SlidingPuzzleGame({ onBack, onGameComplete }: SlidingPuzzleGameProps) {
        ...
        <AnimatePresence mode="wait">
          {gameState === 'menu' && (
            <GameMenu
              ...
              description="Slide the tiles to arrange them in numerical order from 1 to 8."
              icon={<Grid className="w-14 h-14 text-indigo-400" />}
